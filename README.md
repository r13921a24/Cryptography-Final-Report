...
```
├── report/
│   ├── academic_paper_final_v4.tex   # Final academic paper (LaTeX)
│   ├── compiler_bias_report.tex      # Compiler bias analysis (supporting evidence)
│   └── figures/                      # Charts (300 DPI PNG)
├── experiments/                      # Pure Python implementations + benchmark harness
...
│   ├── experiment1_kat/
│   ├── experiment2_throughput/
│   ├── experiment3_init/
│   ├── experiment4_memory/
│   ├── experiment5_codesize/
│   ├── experiment6_energy/
│   └── experiment7_combined/
├── references/                      # NIST standards and specifications
│   ├── NIST.IR.8454.pdf
│   ├── NIST.SP.800-232.pdf
│   └── tinyjambu-spec-final.pdf
├── proposals/                       # Course project proposals
